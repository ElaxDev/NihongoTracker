...
import { assignMediaFn, getUserLogsFn } from '../api/trackerApi.ts';
...
function ReadingLogs({ username, isActive = true }: ReadingLogsProps) {
  ...
  if (logError) {
    return (
      <div className="alert alert-error">
        <span>Error loading reading logs</span>
      </div>
    );
  }
